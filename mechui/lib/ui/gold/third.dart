      ...
      child: Container(
        ...
        child: Column(
          children: <Widget>[
            Container(
              child: Image.network(
                  'https://thumbs.dreamstime.com/z/print-155469267.jpg'),
            ),
            SizedBox(
              height: 10,
            ),
...
color: AppColors.highlighterPink,
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    selectedValue1==true?Text('12 months membership @ Rs. 12000', style: TextStyles.paragraphdemibold1):Text('6 months membership @ Rs. 5000', style: TextStyles.paragraphdemibold1),
                  ],
                ),
              ),
            ),
            ...
            Container(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text('Experienced Mechanics nearby',style: TextStyles.pageSubHeading1,),
                    Text('choose from',style: TextStyles.pageSubHeading1,),
                    SizedBox(height: 5.0,),
                    Text('across Hyderabad and 40 more cities',style: TextStyles.paragraphdemibold2,)
                  ],
                ),
              ),
            ),
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ClipRRect(
                                        ...
                                        child: Image.network('https://st2.depositphotos.com/1835351/5624/i/950/depositphotos_56245793-stock-photo-group-of-automotive-tires.jpg',width: 150.0,height: 100.0,)),
                                    SizedBox(height: 10.0,),
                                    Text('MRF Car Tire',style: TextStyles.actionTitleBlack1,),
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      children: <Widget>[
                              ...
                              Container(
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text('Dilshukhnagar',style: TextStyles.subText,)
                                  ],
                                ),
                              ),
                              SizedBox(width: 10,),
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ClipRRect(
                                        ...
                                        child: Image.network('https://st2.depositphotos.com/1835351/5624/i/950/depositphotos_56245793-stock-photo-group-of-automotive-tires.jpg',width: 150.0,height: 100.0,)),
                                    SizedBox(height: 10.0,),
                                    Text('MERF Car Tire',style: TextStyles.actionTitleBlack1,),
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      children: <Widget>[
                                        Icon(Icons.star,color: AppColors.blackColor,size: 15,),
